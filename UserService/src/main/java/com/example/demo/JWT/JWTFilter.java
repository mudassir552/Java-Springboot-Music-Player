 ...
 * authHeader.substring(7); // System.out.println(jwtservice +"JWTTTTTTTT");
 * 
 * username = jwtservice.extractUsername(token);
 * System.out.println("IN JWWWWWTTTTT"+username); }
 * 
 * if (username != null &&
 * SecurityContextHolder.getContext().getAuthentication()!= null) {
 * 
 * UserDetails userDetails = userinfoservice.loadUserByUsername(username); if
